...
class MainWindow(QMainWindow):
    ...
    def __init__(self, bridge: EngineBridge | None = None) -> None:
        ...
        self._pages: dict[str, tuple[QWidget, str]] = {
            ...
            PAGE_CONSTRAINTS: (self._constraints, "Reglas del horario"),
    ...
    def _build_menu(self) -> None:
        ...
        for label, page in (
            ...
            ("Reglas del horario", PAGE_CONSTRAINTS),
    ...
    def _build_toolbar(self) -> None:
        ...
        nav = (
            ...
            ("Reglas", QStyle.StandardPixmap.SP_FileDialogContentsView, PAGE_CONSTRAINTS),
