...
class BestChart(QWidget):
    ...
    def paintEvent(self, event: QPaintEvent) -> None:
        ...
        if len(self.points) >= 1:
            ...
            pintor.drawText(marco.adjusted(4, 2, -4, -2), Qt.AlignmentFlag.AlignTop, str(v_max))
            pintor.drawText(
...
class OptimizationWindow(QWidget):
    ...
    def _retranslate(self) -> None:
        ...
        self.start_button.setText(self.tr("Iniciar"))
        self.stop_button.setText(self.tr("Detener"))
        ...
        self.open_evaluation.setText(self.tr("Abrir Evaluación"))
        self.open_diagnosis.setText(self.tr("Abrir Diagnóstico"))
    ...
    def start(self) -> bool:
        """Lanza la optimización en segundo plano."""
    ...
    def _update_enabled(self) -> None:
        ...
        self.start_button.setEnabled(self.bridge.has_session and not ocupado)
    ...
    def _on_progress(self, event: object) -> None:
        ...
        self.iteration_label.setText(str(event.iteration))
        self.current_label.setText(str(event.current))
        self.best_label.setText(str(event.best))
        self.unplaced_label.setText(str(event.unplaced))
    ...
    def _on_finished(self, outcome: object) -> None:
        ...
        if outcome.evaluation is not None:
            self.best_label.setText(str(outcome.evaluation.total))
            self.unplaced_label.setText(str(outcome.evaluation.unplaced_periods))
